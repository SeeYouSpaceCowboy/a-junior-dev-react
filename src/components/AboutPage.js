    ...
    return (
      <div>
        ...
        <p className='justify'>
          ...
          unskilled talent by saying 3+ years isn't an excuse. Because talent that
          haven't gotten their foot in the door yet, are also filtered. If things like those resonates
        ...
        <p><a href='https:\\seeyouspacecowboy.github.io/blog' target='_blank'>Personal Site</a></p>
