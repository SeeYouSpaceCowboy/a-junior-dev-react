        ...
        <form onSubmit={ this.submitListing }>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              <input className='fill' type='text' name='position' onChange={ this.handleChange }/>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              <input className='fill' type='text' name='programming_languages' onChange={ this.handleChange }/>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              <select className='fill' name='experience_level' onChange={ this.handleChange }>
                <option value="intern">Intern (0 yrs of experience)</option>
                <option value="junior">Junior (0 - 1 yrs of experience)</option>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              <input className='fill' type='text' name='compensation' placeholder='Compensation' onChange={ this.handleChange }/>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              <textarea className='fill' type='text' name='description' placeholder='Description' onChange={ this.handleChange }/>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-12'>
              <input className='fill' type='text' name='company' placeholder='Company' onChange={ this.handleChange }/>
            </div>
          </div>

          <div className='row'>
            <div className='col-12'>
              <input className='fill' type='text' name='company_url' placeholder='Company URL' onChange={ this.handleChange }/>
            </div>
          </div>

          <div className='row'>
            <div className='col-12'>
              <input className='fill' type='text' name='street' placeholder='Street' onChange={ this.handleChange }/>
            </div>
          </div>

          <div className='row'>
            <div className='col-12'>
              <input className='fill' type='text' name='zipcode' placeholder='Zipcode' onChange={ this.handleChange }/>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-12'>
              <button className='primary center' type='submit'>Submit Listing</button>
            </div>
          </div>
        </form>
        </div>
